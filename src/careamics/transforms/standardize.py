...
class Standardize(Transform):
    """
    Standardization an image or image patch.
...
class Destandardize:
    """
    Destandardize an image.

    Destandardization is performed expecting a zero mean and unit variance input. This
    ...
    def __call__(self, patch: NDArray) -> NDArray:
        """Reverse the standardization operation for a batch of patches.
